...
const SlidersActiveBulk = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      opacity="0.4"
      d="M17.5 3H6.5C8.433 3 10 4.567 10 6.5C10 8.433 8.433 10 6.5 10H17.5C19.433 10 21 8.433 21 6.5C21 4.567 19.433 3 17.5 3Z"
      fill="currentColor"
    ></path>
    <path
      opacity="0.4"
      d="M6.5 14H17.5C15.567 14 14 15.567 14 17.5C14 19.433 15.567 21 17.5 21H6.5C4.567 21 3 19.433 3 17.5C3 15.567 4.567 14 6.5 14Z"
      fill="currentColor"
    ></path>
    <path
...
export default SlidersActiveBulk;
