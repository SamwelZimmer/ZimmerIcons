...
const Cheese = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d="M7 16.2095C7 17.0379 7.67157 17.7095 8.5 17.7095C9.32843 17.7095 10 17.0379 10 16.2095C10 15.381 9.32843 14.7095 8.5 14.7095C7.67157 14.7095 7 15.381 7 16.2095Z"
      stroke="currentColor"
      strokeWidth="1.5"
    />
  </svg>
